<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/General.Master" AutoEventWireup="true" CodeBehind="category.aspx.cs" Inherits="FreePDF.category" %>
    ...
    <asp:UpdatePanel ID="pnlUpdatePage" runat="server">
        <ContentTemplate>
                ...
                <ItemTemplate>
                    <div class="lastest_doc-item">
	                    ...
	                    <div class="doc_info">
		                    ...
		                    <%--<p class="doc_tags"><b>Tags: </b><a href="#">C</a>, <a href="#">Programming</a>, <a href="#">Python</a>, <a href="#">Linux</a></p>--%>
		                    <p class="doc_details">
			                    <%# Eval("Description") %>
		                    </p>
	                    </div>
            ...
            <div id="pagination" class="space">
                <myControl:DataPaging ID="dataPaging" PageSize="5" runat="server" />               
